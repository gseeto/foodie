<?php
	...
	class MenuDataGridGen extends QDataGrid {
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Menu::QueryCount($objCondition, $objClauses);
			...
			$this->DataSource = Menu::QueryArray($objCondition, $objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Description': return QQN::Menu()->Description;
				case 'OwnerId': return QQN::Menu()->OwnerId;
				case 'Owner': return QQN::Menu()->Owner;
