<?php
	 ...
	 * listing a collection of IngredientSource objects.  It includes
	 ...
	 * 
	 */
	class IngredientSourceDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this IngredientSource datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the IngredientSource object, or it can be any QQNode extending from QQN::IngredientSource().
		 * 
		 ...
		 * sorting using two fields from the IngredientSource object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from IngredientSource
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = IngredientSource::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from IngredientSource, given the clauses above
			$this->DataSource = IngredientSource::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a IngredientSource-based QQNode.
		 * It will also verify that it is a proper IngredientSource-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'ingredient_source') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "ingredient_source".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::IngredientSource()->Id;
				case 'IngredientId': return QQN::IngredientSource()->IngredientId;
				case 'Ingredient': return QQN::IngredientSource()->Ingredient;
				case 'LocationId': return QQN::IngredientSource()->LocationId;
				case 'Location': return QQN::IngredientSource()->Location;
				case 'Cost': return QQN::IngredientSource()->Cost;
				case 'QualityId': return QQN::IngredientSource()->QualityId;
				case 'Quality': return QQN::IngredientSource()->Quality;
				case 'Comments': return QQN::IngredientSource()->Comments;
				case 'Name': return QQN::IngredientSource()->Name;
				default: throw new QCallerException('Simple Property not found in IngredientSourceDataGrid content: ' . $mixContent);
