<?php
	 ...
	 * listing a collection of Category objects.  It includes
	 ...
	 * 
	 */
	class CategoryDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Category datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Category object, or it can be any QQNode extending from QQN::Category().
		 * 
		 ...
		 * sorting using two fields from the Category object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Category
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Category::QueryCount($objCondition, $objClauses);
			...
			$this->DataSource = Category::QueryArray($objCondition, $objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::Category()->Id;
				case 'Group': return QQN::Category()->Group;
				case 'Name': return QQN::Category()->Name;
				default: throw new QCallerException('Simple Property not found in CategoryDataGrid content: ' . $mixContent);
