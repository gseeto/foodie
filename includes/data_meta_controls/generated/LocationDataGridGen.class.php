<?php
	 ...
	 * listing a collection of Location objects.  It includes
	 ...
	 * 
	 */
	class LocationDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Location datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Location object, or it can be any QQNode extending from QQN::Location().
		 * 
		 ...
		 * sorting using two fields from the Location object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Location
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Location::QueryCount($objCondition, $objClauses);
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::Location()->Id;
				case 'Address': return QQN::Location()->Address;
				case 'Website': return QQN::Location()->Website;
				default: throw new QCallerException('Simple Property not found in LocationDataGrid content: ' . $mixContent);
