<?php
	...
	class Location extends LocationGen {
		...
		public function __toString() {
			return sprintf('Location Object %s',  $this->intId);
		}
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of Location objects
			return Location::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::Location()->Param1, $strParam1),
					QQ::GreaterThan(QQN::Location()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single Location object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of Location objects
			return Location::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::Location()->Param1, $strParam1),
					QQ::Equal(QQN::Location()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
