...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			...
			return Category::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::Category()->Param1, $strParam1),
					QQ::GreaterThan(QQN::Category()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single Category object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of Category objects
			return Category::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::Category()->Param1, $strParam1),
					QQ::Equal(QQN::Category()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
