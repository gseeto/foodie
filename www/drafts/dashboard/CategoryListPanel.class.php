<?php
	 ...
	 * 
	 */
	class CategoryListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list Categories
		public $dtgCategories;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'CategoryListPanel.tpl.php';
			...
			$this->dtgCategories->ItemsPerPage = 8;
			...
			$this->dtgCategories->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
		...
		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			...
			$objEditPanel = new CategoryEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
