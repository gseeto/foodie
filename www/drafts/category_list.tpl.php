<?php
	...
	$strPageTitle = QApplication::Translate('Categories') . ' - ' . QApplication::Translate('List All');
...
?>
	...
	<div id="titleBar">
		...
		<h1><?php _t('Categories'); ?></h1>
	</div>

	<?php $this->dtgCategories->Render(); ?>

	<p class="create">
		<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/category_edit.php"><?php _t('Create a New'); ?> <?php _t('Category');?></a>
	</p>
