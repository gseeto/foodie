...
class EditMenuForm extends FoodieForm {
	...
	protected function Form_Create() {
		...
		$this->txtMenuDescription->Text = $this->objMenu->Description;
        ...
        $this->pnlAddDessert->AutoRenderChildren = true;
	 	...
	 	$this->btnSubmit->Text = 'Update Menu';
